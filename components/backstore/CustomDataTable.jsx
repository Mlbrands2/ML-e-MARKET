...
export default function Page() {
  ...
  return (
    <div className="">
      <h2 className="text-xl font-bold mb-4 text-black px-4">Recent Order</h2>
      {/* Table */}
          ...
          <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
            <li>
              <button
                ...
                className="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-300 bg-white border border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
